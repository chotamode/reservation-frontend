    ...
    return (
        <div className={`fixed inset-0 bg-gray-800 bg-opacity-75 z-50 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out`}>
            <div className="bg-white w-64 h-full p-4">
                ...
                <nav className="mt-4">
                    <Link to="/public" className="block text-gray-700 hover:text-gray-900 my-2">Home</Link>
                    ...
                    <Link to="/login" className="block text-gray-700 hover:text-gray-900 my-2">Login</Link>
                </nav>
            </div>
        </div>
    );
