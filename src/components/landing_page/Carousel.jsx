...
function Carousel({ psychologists }) {
    ...
    return (
        <div
            className="bg-white rounded-3xl border-black w-[75rem] flex flex-col items-center justify-center p-14">
            ...
            <div className="w-full h-[31.625rem] flex space-x-6 mb-12 mt-16">
