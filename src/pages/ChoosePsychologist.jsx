        ...
        <div className="bg-white p-5 rounded-3xl font-roboto drop-shadow-md flex flex-col h-full">
            <div className="flex flex-col gap-7 flex-grow">
                ...
                <div className="flex flex-wrap gap-2 mb-10">
                    {psychologist.practices.map((practice, index) => (
            ...
            <button className="rounded-2xl bg-[#D3DBA8] w-full h-10 text-sm font-semibold mt-auto">
                Записаться
            </button>
        </div>
    );
...
function ChoosePsychologist() {
    return (<div>
        ...
        <button className={"rounded-3xl bg-[#DBEAFE] w-full h-14 text-lg font-semibold my-16"}>
            Хочу посмотреть еще специалистов!
        </button>
